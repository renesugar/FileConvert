...
std::string DatumToString(Datum d, const SQLTypeInfo& ti) {
  switch (ti.get_type()) {
    case kBOOLEAN:
      return BooleanToString(d.boolval);
    case kNUMERIC:
    case kDECIMAL:
      return DecimalToString(d.bigintval, ti.get_dimension(), ti.get_scale());
    case kINT:
    ...
    case kTIME:
      return TimeToString(d.timeval);
    case kTIMESTAMP:
      return TimestampToString(d.timeval);
    case kDATE:
      return DateToString(d.timeval);
    case kINTERVAL_DAY_TIME:
      return IntervalDayTimeToString(d.timeval);
    case kINTERVAL_YEAR_MONTH:
      return IntervalYearMonthToString(d.timeval);
    case kTEXT:
    case kVARCHAR:
    case kCHAR:
      return *d.stringval;
